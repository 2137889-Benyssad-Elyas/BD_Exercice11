CREATE DATABASE if not exists Exercice11_LDVELHd;
use Exercice11_LDVELHd;
CREATE TABLE objet
(
...
CREATE USER 'hero' IDENTIFIED BY 'qwerty1234';
GRANT SELECT, INSERT, UPDATE, ALTER, CREATE
ON Exercice11_LDVELH
TO hero;
